...
const products = [
  ...
  { id: 323, img: "https://img.forestessentialsindia.com/pub/media/home/category/Body-Care.jpg", title: "Body Care", price: "₹399" },
  ...
  { id: 71, img: "https://img.forestessentialsindia.com/pub/media/home/category/Travel-Minis.jpg", title: "Sunscreen", price: "₹499" },
  ...
  { id: 589, img: "https://img.forestessentialsindia.com/pub/media/home/category/Makeup.jpg", title: "Makeup", price: "₹799" },
  { id: 234, img: "https://img.forestessentialsindia.com/pub/media/home/category/Hair-Care.jpg", title: "Hair Care", price: "₹499" },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {products.map((product) => (
          <div key={product.id} className="bg-white shadow-lg rounded-lg p-4 text-center">
            ...
            <button className="mt-3 w-full bg-black text-white border-2 py-2 rounded-lg hover:bg-white hover:text-black hover:border-black transition" onClick={() => {HandleAddToCart(product)}}>
              Add to Cart
            </button>
          </div>
        ))}
